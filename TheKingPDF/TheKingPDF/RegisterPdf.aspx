<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterPdf.aspx.cs" Inherits="TheKingPDF.RegisterPdf" %>
	...
	<div class="container">
		<div class="row">
			<div class="py-5 col-sm-12 text-center">
		        <h2 class="text-center" style="font-weight: bold;">Cadastro de Conteúdo</h2>
		    </div>
		</div>
	</div>
	<!-- FORM -->
	<div class="container bg-form">
		<div class="row">
			<div class="col-md-12 col-lg-6 order-md-1">
				...
				<div class="col-md-12 col-lg-6 order-md-1">
					<asp:Button type="submit" style="width: 100% !important;" runat="server" class="mg-top30 btn btn-primary btn-login" ID="BtnCadastrar" Text="Cadastrar" OnClick="BtnCadastrar_Click"></asp:Button>
				</div>
				<div class="col-md-12 col-lg-6 order-md-1">
